...
\begin{document}
	...
	Highly efficient brushless motor controller for drones. Supports sensorless field-oriented control for maximal power efficiency, resulting in increased flight time and smoother operation compared to off-the-shelf alternatives.
	...
	\end{itemize}
	\subsection{Lab Assistant -- UCSB Department of Physics (April 2023--June 2024)}
	\begin{center}
		\begin{minipage}{0.5\textwidth}
			\begin{itemize}[itemsep=0em]
